...
class PlacesDetails extends React.Component {
  ...
  render() {
    ...
    const placePhoto = Array.isArray(place.photos) ? place.photos[0].getUrl({'maxWidth': 400, 'maxHeight': 150}) : '../client/assets/noimage.jpg';
    ...
    return (
      <div id="details-container">
        <div className="fake-link" onClick={this.props.returnToList}>Return to list</div>
